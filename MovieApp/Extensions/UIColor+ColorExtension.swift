...
extension UIColor {
    ...
    static var tabBarItemAccent: UIColor {
        #colorLiteral(red: 0.03137254902, green: 0.4901960784, blue: 0.9647058824, alpha: 1)
    }
    
    static var tabBarItemLight: UIColor {
        #colorLiteral(red: 0.3450980392, green: 0.4509803922, blue: 0.6117647059, alpha: 1)
    }
